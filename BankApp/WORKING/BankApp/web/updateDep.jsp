...
<body style="background: radial-gradient(black, var(--bs-blue) 50%, white);">
    ...
    <%
        ...
        String depCur = request.getParameter("depoCurrency");
        String depDes = request.getParameter("depoDescription");
        ...
        try{
            ...
            if (rs.next()){
                ...
                sqlInt = 5;
                s.ReadSQL(sqlInt);
                st.executeUpdate(s.getSQLAll() + "('"+email+"','"+createTime+"','"+depDes+"','"+depCur+"')");
